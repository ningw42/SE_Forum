...
create table user_simple(u_id int,
...
#forum board
create table forum_board(b_id int,
b_name char(20),
...
#post topic
create table posts_topic(p_id int,
title varchar(60),
author_id int,
author varchar(20),
...
#post reply
create table posts_reply(r_id int,
p_id int,
replier_id int,
replier varchar(20),
content text,
...
#forum message
create table forum_message(m_id int,
sender_id int,
receiver_id int,
